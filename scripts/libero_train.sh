# setsid nohup bash scripts/libero_train.sh > /data/shared_workspace/zhangshiqi/uwm_motion_rst_saving/libero_bowl_drawer/libero_bowl_drawer_RAFT_MASK_no_mixture_V2.log 2>&1 &
...
CUDA_VISIBLE_DEVICES=7,8,9 python experiments/dp/train_robomimic.py \
    --config-name train_dp_robomimic.yaml \
    exp_id="libero_bowl_drawer_RAFT_MASK_no_mixture_V2" \
