# setsid nohup bash scripts/libero_train.sh > /data/shared_workspace/zhangshiqi/uwm_motion_rst_saving/libero_10/libero_10_MV_no_MASK_no_mixture.log 2>&1 &
...
CUDA_VISIBLE_DEVICES=6,7,8,9 python experiments/dp/train_robomimic.py \
    ...
    exp_id="libero_10_MV_no_MASK_no_mixture" \
