# setsid nohup bash scripts/libero_train.sh > /data/shared_workspace/zhangshiqi/uwm_motion_rst_saving/libero_10/libero10_MV_no_Mask_no_mixture.log 2>&1 &
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python experiments/dp/train_robomimic.py \
    ...
    exp_id="libero10_MV_no_Mask_no_mixture" \
