...
z3 = zarr.open("/data/shared_workspace/zhangshiqi/dataset/libero/datasets/libero_10/STUDY_SCENE1_pick_up_the_book_and_place_it_in_the_back_compartment_of_the_caddy_demo.zarr", mode="r")
