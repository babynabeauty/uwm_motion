...
class RobomimicDataset(Dataset):
    ...
    def _init_buffer(self, hdf5_path_globs, buffer_path):
        ...
        metadata["optical_flow_raft_latent"] = {"shape": (4, 16, 16), "dtype": np.float32}
        metadata["optical_flow"] = {"shape": (2, 128, 128), "dtype": np.float32}
        ...
        for hdf5_path in hdf5_paths:
            with h5py.File(hdf5_path) as f:
                ...
                for i in range(len(demos)):
                    ...
                    if "optical_flow" in demo:
                        episode["optical_flow"] = demo["optical_flow"][:]
